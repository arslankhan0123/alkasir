          ...
          <?php if ($CI->permissions('quotation_add')) { ?>
            <li class="border_bottom">
              <a href="<?php echo $base_url; ?>quotation/add">
                <h4><i class="fa fa-plus text-green"></i> <?= $this->lang->line('quotation'); ?></h4>
              </a>
            </li>
          <?php } ?>
...
<style>
  ...
  .skin-blue .sidebar-menu>li.active>a {
    color: #fff;
    background: #1090C2 !important;
    border-left-color: #f5c122;
  }
    ...
    <ul class="sidebar-menu" style="background-color: #28ACE2 !important;">
      ...
      <?php if (($CI->permissions('discountCouponView') || $CI->permissions('customerCouponView')) && !is_admin()) { ?>
        ...
        <li class="coupon-active-li treeview">
          <a href="#">
            <i class=" fa fa-tags text-aqua"></i> <span><?= $this->lang->line('coupons'); ?><!-- new tag disabled <span class="">
<small class="label bg-green">new</small>
        ...
        <?php if ($CI->permissions('services_add') || $CI->permissions('services_view') || $CI->permissions('items_add') || $CI->permissions('items_view') || $CI->permissions('items_category_add') || $CI->permissions('items_category_view') || $CI->permissions('brand_add') || $CI->permissions('brand_view') || $CI->permissions('print_labels') || $CI->permissions('import_items') || $CI->permissions('import_services') || $CI->permissions('variant_view') || $CI->permissions('services_view')) { ?>
          ...
          <li class="items-list-active-li items-active-li  category-view-active-li category-active-li brand-active-li brand-view-active-li labels-active-li import_items-active-li services-active-li import_services-active-li variants-active-li variants_list-active-li services-active-li treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li class="department-view-active-li"><a href="<?php echo $base_url; ?>Department/view"><i class="fa fa-list "></i> <span>Department List</span></a></li>
            ...
            -->
              ...
              <li class="subcategory-view-active-li"><a href="<?php echo $base_url; ?>Szcategory/view"><i class="fa fa-list "></i> <span>Sizes List</span></a></li>

              <li class="subcategory-view-active-li"><a href="<?php echo $base_url; ?>Rack/view"><i class="fa fa-list "></i> <span>Rack List</span></a></li>

              <li class="subcategory-view-active-li"><a href="<?php echo $base_url; ?>Bncategory/view"><i class="fa fa-list "></i> <span>Bin List</span></a></li>
      ...
      <?php if (special_access()) { ?>
        <li class="country-active-li city-list-active-li country-list-active-li state-active-li state-list-active-li city-active-li treeview">
          ...
          <ul class="treeview-menu">
            ...
            <!-- City menu disabled
            <li class="state-list-active-li "><a href="<?php echo $base_url; ?>places_city"><i class="fa fa-list "></i> <span>City</span></a></li>
            -->

            <!-- Area menu disabled
            <li class="state-list-active-li "><a href="<?php echo $base_url; ?>places_area"><i class="fa fa-list "></i> <span>Area</span></a></li>
            -->
          </ul>
        </li>
      <?php } ?>
      ...
      <!-- SMS -->
      <!-- Messaging menu disabled (parent + Send Message + Messaging Templates)
        ...
        <li class="report-sales-active-li report-sales-return-active-li report-purchase-active-li report-purchase-return-active-li report-expense-active-li report-stock-active-li report-purchase-payments-active-li report-sales-item-active-li report-sales-payments-active-li report-expired-items-active-li report-supplier_items-active-li report-seller-points-active-li report-sales-tax-active-li report-purchase-tax-active-li  report-delivery-sheet-active-li report-load-sheet-active-li report-return-item-active-li report-sales-active-li  reports-menu treeview">
          ...
          <ul class="treeview-menu">
            ...
            <?php if ($CI->permissions('return_items_report')) { ?>
              <li class="report-return-item-active-li"><a href="<?php echo $base_url; ?>reports/return_item"><i class="fa fa-files-o "></i> <span><?= $this->lang->line('return_items_report'); ?></span><!-- new tag disabled <span class="pull-right-container">
              <small class="label pull-right bg-green">new</small>
              </span> --></a></li>
            <?php } ?>
            ...
            <li class="report-sales-payments-active-li"><a href="<?php echo $base_url; ?>reports/customer_statements"><i class="fa fa-files-o "></i> <span>Customer Statements</span></a></li>
            <li class="report-sales-payments-active-li"><a href="<?php echo $base_url; ?>reports/supplier_statements"><i class="fa fa-files-o "></i> <span>Supplier Statements</span></a></li>
          </ul>
        </li>
      <?php } ?>
